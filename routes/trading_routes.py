...
# from services.ai_analysis_service import AIAnalysisService  # ML service removed
...
# ai_analysis = AIAnalysisService(OANDA_CREDS['ACCESS_TOKEN'])  # ML service removed
trading_strategy = TradingStrategyService()
risk_management = RiskManagementService()

# @trading_bp.route('/api/analyze-asset', methods=['POST'])  # ML route removed
